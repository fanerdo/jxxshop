	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<?php if(empty($_SESSION['user_id'])): ?><li>您好，欢迎来到京西！[<a href="<?php echo U('User/login');?>">登录</a>] [<a href="<?php echo U('User/register');?>">免费注册</a>] </li>
					<?php else: ?>
						<li>您好 <b><?php echo ($_SESSION['user']['username']); ?></b>，欢迎来到京西！[<a href="<?php echo U('User/logout');?>">退出</a>]</li><?php endif; ?>
					<li class="line">|</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			...
			<div class="cart fl">
				<dl>
					<dt>
						<a href="<?php echo U('Home/Cart');?>">去购物车结算</a>
						<b></b>
					</dt>
					<dd>
						<div class="prompt">
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<?php if(is_array($data["price"])): $i = 0; $__LIST__ = $data["price"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><dd <?php if(($_GET['price']) == $vv): ?>class="cur"<?php endif; ?>><a href="<?php echo myU('price',"$vv");?>"><?php echo ($vv); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>
					...
					<?php if(is_array($data["attrwhere"])): $i = 0; $__LIST__ = $data["attrwhere"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						...
						<?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd <?php if(($_GET['attr']) == $v['attr_values']): ?>class="cur"<?php endif; ?> ><a href="<?php echo myU('attr',$v['attr_values']);?>"><?php echo ($v["attr_values"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
