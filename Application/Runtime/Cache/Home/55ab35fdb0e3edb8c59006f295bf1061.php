			...
			<div class="order_bd mt10">
				<table class="orders">
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php if(($vo["pay_status"]) == "0"): ?><a href="<?php echo U('Order/pay','order_id='.$vo['id']);?>">继续支付</a> |<?php endif; ?>
							<?php if(($vo["order_status"]) == "2"): ?><a href="<?php echo U('express','order_id='.$vo['id']);?>">查看快递</a> |<?php endif; ?>
							<a href="">删除</a></td>
