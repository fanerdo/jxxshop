    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td align="center"><?php echo ($data['num']+$i); ?></td>
                ...
                <td align="center">
                <a href="<?php echo U('setNumber','goods_id='.$vo['id']);?>" target="_blank" title="属性添加">库存设置</a>
                <a href="<?php echo U('edit','id='.$vo['id']);?>" title="编辑"><img src="/Public/Admin/Images/icon_edit.gif" width="16" height="16" border="0" />商品编辑</a>
                <a href="<?php echo U('dels','id='.$vo['id']);?>" onclick="" title="回收站"><img src="/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" />回收站</a></td>
