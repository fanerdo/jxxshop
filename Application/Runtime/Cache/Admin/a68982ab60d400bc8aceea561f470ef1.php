...
<head>
<title>ECSHOP 管理中心 - 分类商品添加 </title>
...
<div class="main-div">
    ...
    <div class="tab-div">
        ...
        <div id="tabbody-div">
            <form enctype="multipart/form-data" action="" method="post">
                <table width="90%" class='table' id="general-table" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            促销价格 <input type="text" name="cx_price" value="<?php echo ($data["cx_price"]); ?>" size="20" />
                            开始时间 <input type="text" name="start" <?php if(($data["start"]) != "0"): ?>value="<?php echo (date('Y-m-d H:i:s',$data["start"])); ?>"<?php endif; ?> size="20" />
                            结束时间 <input type="text" name="end" <?php if(($data["start"]) != "0"): ?>value="<?php echo (date('Y-m-d H:i:s',$data["end"])); ?>"<?php endif; ?> size="20" />
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="cate_id">
                                ...
                                <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($data["cate_id"]) == $vo["id"]): ?>selected="selected"<?php endif; ?>>|<?php echo (str_repeat('--',$vo["lev"])); echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(is_array($ext)): $i = 0; $__LIST__ = $ext;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><select name="ext_cate_id[]">
                                <option value="0">|--请选择</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="is_sale" value="1" <?php if(($data["is_sale"]) == "1"): ?>checked="checked"<?php endif; ?> /> 是
                            <input type="radio" name="is_sale" <?php if(($data["is_sale"]) == "0"): ?>checked="checked"<?php endif; ?> value="0"/> 否
                        </td>
                    </tr>
                    <tr>
                        <td class="label">加入推荐：</td>
                        <td>
                            <input type="checkbox" <?php if(($data["is_hot"]) == "1"): ?>checked="checked"<?php endif; ?> name="is_hot" value="1" /> 热卖
                            <input type="checkbox" <?php if(($data["is_new"]) == "1"): ?>checked="checked"<?php endif; ?> name="is_new" value="1" /> 新品
                            <input type="checkbox" <?php if(($data["is_rec"]) == "1"): ?>checked="checked"<?php endif; ?> name="is_rec" value="1" /> 推荐
            ...
            <script id="editor" name="goods_body" type="text/plain" style="width:1024px;height:500px;"><?php echo ($data["goods_body"]); ?></script>
            </td>
            </tr>
            </table>
            ...
            <select name="type_id" id="type_id">
                ...
                <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($data["type_id"]) == $vo["id"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
            </td>
            </tr>
            <tr>
